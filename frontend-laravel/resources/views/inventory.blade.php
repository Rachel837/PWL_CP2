            ...
            <table class="table mb-0 text-nowrap table-hover">
              ...
              <tbody>
                ...
                <tr class="align-middle">
                  <td><a href=""><img src="{{ asset('assets/images/product-1.png') }}" alt="" class="avatar avatar-md rounded" /><span class="ms-3">{{ $item['nama_barang'] ?? 'No Name' }}</span></a>
                  </td>
                  <td>PRD-{{ $item['id'] ?? 'N/A' }}</td>
                  <td>Electronics</td>
                  <td>Brand Name</td>
                  <td>Rp. 0</td>
                  <td>{{ $item['satuan'] ?? '-' }}</td>
                ...
                @empty
                <tr>
                    <td colspan="8" class="text-center">Tidak ada data barang dari Node.js API</td>
                </tr>
                @endforelse
              </tbody>
              <tfoot class="">
