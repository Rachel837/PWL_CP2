<aside id="sidebar" class="sidebar">
    <div class="logo-area">
        <a href="/" class="d-inline-flex"><img
    ...
    <ul class="nav flex-column">
        @if(Session::has('user') && Session::get('user')['role'] === 'administrator')
            ...
            <li><a class="nav-link {{ request()->is('users*') ? 'active' : '' }}" href="{{ route('users.index') }}"><i
                        class="ti ti-users"></i><span class="nav-text">Pengguna</span></a></li>
            <li><a class="nav-link {{ request()->is('ruangan*') ? 'active' : '' }}" href="{{ route('ruangan.index') }}"><i
        ...
        @if(Session::has('user') && Session::get('user')['role'] === 'kepala laboratorium')
            <li><a class="nav-link {{ request()->is('draft-pengadaan/history') ? 'active' : '' }}"
                    href="{{ route('draft-pengadaan.history') }}"><i class="ti ti-history"></i><span
                        class="nav-text">History Pengadaan</span></a></li>
        @endif
